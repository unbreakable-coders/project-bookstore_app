...
export const CartItem: FC<CartItemProps> = ({
  ...
  return (
    <div className="bg-card rounded-xl border border-border p-4 sm:p-6 flex flex-col gap-4">
      <div className="flex items-start gap-4">
        <button
          onClick={onRemove}
          className="mt-1 text-accent hover:text-destructive transition-transform cursor-pointer hover:scale-110"
      ...
      <div className="w-full border border-accent rounded-lg px-4 py-3 flex items-center justify-between">
